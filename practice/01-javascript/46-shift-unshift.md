...
flowchart TD
    N1["unshift()"]
    N2["добавляет новый первый элемент"]
    N3["смещает существующие indexes вправо"]
    N4["shift()"]
    N5["удаляет первый элемент"]
    N6["возвращает удаленное value"]
    N7["смещает оставшиеся indexes влево"]
    N1 --> N2
    N1 --> N3
    N1 --> N4
    N4 --> N5
