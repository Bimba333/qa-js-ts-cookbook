...
Определите receiver и значение `this`.
...
Для каждого вызова определите receiver.
...
Исправьте object method так, чтобы он возвращал `name` текущего receiver.
...
7. Объясните, почему receiver был потерян.
