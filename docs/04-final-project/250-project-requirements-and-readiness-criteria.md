...
**Миф: требования можно уточнить по ходу реализации.**
Тогда готовность проекта становится вопросом мнения, а не проверки. Критерии приёмки задаются заранее.

**Миф: чем больше сценариев в портфеле, тем лучше проект.**
Ценность даёт покрытие разных рисков и слоёв, а не количество однотипных проверок.

**Миф: трассируемость — бюрократия.**
Она отвечает на вопрос, каким тестом подтверждено конкретное требование. Без неё нельзя показать полноту.

**Миф: Definition of Done можно дописать в конце.**
Определение готовности, составленное после работы, всегда подгоняется под результат.

**Миф: пригодность стенда проверяется при первом падении.**
Она проверяется до начала: иначе первые дни уходят на диагностику окружения, а не на проект.

## Частые вопросы

**Зачем фиксировать критерии приёмки до реализации?**
Чтобы готовность определялась проверкой, а не ощущением.

**Сколько сценариев брать в портфель?**
Столько, чтобы были задействованы разные слои и разные классы риска.

**Что делать, если требование нельзя проверить автоматически?**
Записать это явно и указать, как оно проверяется иначе.

**Зачем отдельная проверка пригодности SUT?**
Чтобы отличать дефекты проекта от проблем стенда с первого дня.

**Как понять, что глава завершена?**
По списку проверки перед следующей главой: все его пункты должны выполняться.
