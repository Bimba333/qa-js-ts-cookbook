...
параллельно запущенные Promise
│
▼
быстрее для независимых задач
```
...
нужны итоги всех операций?           -> Promise.allSettled()
...
```text
независимые асинхронные операции
│
▼
запустить вместе
│
▼
выбрать стратегию ожидания
```
