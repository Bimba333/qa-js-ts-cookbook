...
│
▼
исправить источник данных или условие
│
▼
проверить результат
```
...
│
▼
измеряем performance
│
▼
исследуем symptoms и root causes
│
▼
готовимся писать большие проекты безопаснее
```
