import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-NU6TOOTD.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-MVMKIU54.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VKFMJZFB-FKCWCZRL.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-5IMT3BWC-MPIFDLVE.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
...
//# sourceMappingURL=chunk-SVWPURRR.js.map
